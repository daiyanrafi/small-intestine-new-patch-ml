# -*- coding: utf-8 -*-
"""Small_intestine.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Zltf9TGchiiPOhmTjcv-13apJnGp6khE
"""
...
! sudo cp -v -r "/mydrive/Dataset/AICE_project.zip" "/content/dataset"

! unzip /content/dataset/AICE_project.zip  -d /content/dataset/
...
! sudo cp -v -r "/yolov5" "/content/dataset"
...
! sudo cp -v -r  "/mydrive/Dataset/images" "/content/dataset/"
! sudo cp -v -r   "/mydrive/Dataset/labels" "/content/dataset/"
...
labelPath = "/content/dataset/labels/"
imagePath = "/content/dataset/images/"
...
! sudo cp -v -r "/content/dataset/images" "/mydrive/Dataset/" 
! sudo cp -v -r  "/content/dataset/labels" "/mydrive/Dataset/"
...
!python train.py --img 640 --batch 20 --epochs 30 --data smallIntestine.yaml --weights yolov5n.pt

! python train.py --img 640 --batch 20 --epochs 50 --data smallIntestine.yaml --weights yolov5n.pt

! python train.py --img 640 --batch 30 --epochs 50 --data smallIntestine.yaml --weights yolov5n.pt

! python train.py --img 640 --batch 20 --epochs 50 --data smallIntestine.yaml --weights yolov5s.pt

!python train.py --img 640 --batch 20 --epochs 50 --data smallIntestine.yaml --weights yolov5m.pt

! sudo cp -v -r "/content/dataset/yolov5/runs/train/exp" "/content/gdrive/MyDrive/Dataset"